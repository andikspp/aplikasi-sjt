...
@section('title', 'Grafik Individu - ' . $userName)
...
@section('content')
    ...
    <div class="main-wrapper animate__animated animate__fadeIn">
        ...
        <div class="header-section">
            <a href="{{ route('jawaban.peserta', ['userId' => $userId]) }}"
                class="back-button animate__animated animate__fadeInLeft">
            ...
            <div class="header-content animate__animated animate__fadeInDown">
                ...
                <p class="header-subtitle">
                    Visualisasi Performa Personal dalam Bentuk Grafik Interaktif
                </p>
        ...
        <div class="stats-overview">
            <div class="stats-grid animate__animated animate__fadeInUp">
                <div class="stat-card">
                    ...
                    <div class="stat-number" id="totalQuestions">{{ array_sum($scoreData) }}</div>
                ...
                @php
                    $totalScore = 0;
                    $totalCount = 0;
                    foreach ($scoreData as $score => $count) {
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Color schemes
                const colors = {
                    primary: ['#ffc107', '#ff9800', '#f57c00', '#e65100'],
                            ...
                            tooltip: {
                                ...
                                callbacks: {
                                    afterBody: function(tooltipItems) {
                                        ...
                                        const questionCount = @json($questionCountByCompetency)[competency];
                                        return `Jumlah soal: ${questionCount}\nPersentase: ${percentageByCompetency[competency]}%`;
                                    }
                                }
                            }
                        },
            ...
            setTimeout(() => {
                ...
                toast.fire({
                    icon: 'success',
                    title: 'Grafik individual berhasil dimuat!'
                });
            }, 2000);

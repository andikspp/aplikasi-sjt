...
@section('content')
    ...
    <div class="main-wrapper animate__animated animate__fadeIn">
        ...
        <div class="header-section">
            ...
            <div class="header-content animate__animated animate__fadeInDown">
                ...
                <p class="header-subtitle">
                    Visualisasi Data Skor Guru dalam Bentuk Grafik Interaktif
                </p>
            </div>
        </div>
        ...
        <div class="stats-overview">
            <div class="stats-grid animate__animated animate__fadeInUp">
                <div class="stat-card">
                    ...
                    <div class="stat-number" id="totalGuru">{{ $jumlahGuru }}</div>
        ...
        <div class="insights-section animate__animated animate__fadeInUp">
            <h3 class="section-title" style="font-size: 1.8rem;">Insight & Analisis</h3>
            <div class="insights-grid">
                ...
                <div class="insight-card">
                    ...
                    <p class="insight-text">
                        Skor 4.0 = Sangat Baik, 3.0 = Baik, 2.0 = Cukup, 1.0 = Perlu Perbaikan. Hover pada grafik untuk
                        melihat detail jumlah soal dan persentase capaian.
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Bar Chart - MENGGUNAKAN RATA-RATA SKOR
                        ...
                        tooltip: {
                            ...
                            callbacks: {
                                afterBody: function(tooltipItems) {
                                    ...
                                    const percentage = percentageByCompetency[competency];
            ...
            // Performance Chart (Radar) - MENGGUNAKAN RATA-RATA SKOR
            ...
            // Update chart titles untuk kejelasan
            document.querySelector('#scoreBarChart').closest('.chart-card').querySelector('.chart-title')
                .innerHTML =
                '<i class="fas fa-chart-bar me-2"></i>Rata-rata Skor per Kompetensi';

...
@section('content')
    ...
    <div class="container mt-5">
        <div class="form-container">
            ...
            <form action="{{ route('admin.storeQuestionKepsek') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select name="kompetensi_kepsek" id="kompetensi" class="form-control">
                ...
                <div class="mb-3">
                    ...
                    <select name="indikator_kepsek" id="indikator" class="form-control">

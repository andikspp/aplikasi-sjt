...
@section('content')
    ...
    <div class="container mt-5">
        <h2 class="text-center mb-4">Tambah Data Kepala Sekolah</h2>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('store.register.kepsek') }}" method="POST">
                            @csrf
                            @method('POST')
                            <!-- Nama -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('jenis_paud') is-invalid @enderror" id="jenis_paud"
                                    ...
                                    <option value="mitra" {{ old('jenis_paud') == 'mitra' ? 'selected' : '' }}>Mitra
                                    </option>
                                    <option value="pembelajar" {{ old('jenis_paud') == 'pembelajar' ? 'selected' : '' }}>
                                        Pembelajar</option>
                                </select>
                                @error('jenis_paud')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <!-- Role (Auto-set to Kepala Sekolah) -->
                            <input type="hidden" name="role" value="Kepala Sekolah">

...
Route::post('/admin/kepsek/register', [RegisterController::class, 'registerKepsek'])->name('store.register.kepsek');
Route::post('/admin/guru/register', [RegisterController::class, 'registerGuru'])->name('store.register.guru');
